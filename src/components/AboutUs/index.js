...
const AboutUs = () => {
  return (
    <div className="container">
      <div className="row -mt-[25px] __lg:mt-[100px] ">
        <div className="  flex flex-wrap items-center">
          <div className="col-lg-8 col-sm-8 p-8">
          ...
          <div className="col-lg-4 col-sm-4 p-8 ">
            <img
        ...
        <div className="  flex flex-wrap items-center">
          <div className="col-lg-4 col-sm-4  p-8 hidden sm:block md:block lg:block">
            <img
              className=""
              src="https://thumbs.dreamstime.com/b/conception-bleue-d-illustration-du-fond-de-l-ic%C3%B4ne-abr%C3%A9g%C3%A9-pages-document-isol%C3%A9-sur-la-abstraite-167325917.jpg"
              alt=""
          ...
          <div className="col-lg-4 col-sm-4 p-8 block sm:hidden md:hidden lg:hidden">
            <img
              className=""
              src="https://thumbs.dreamstime.com/b/conception-bleue-d-illustration-du-fond-de-l-ic%C3%B4ne-abr%C3%A9g%C3%A9-pages-document-isol%C3%A9-sur-la-abstraite-167325917.jpg"
              alt=""
        ...
        <div className="row flex  justify-center">
          ...
          <div className="col-12 flex items-center  bg-white/70 rounded-lg">
